...
#python3 python_visualizer.py `ruby -e "puts (0..3).to_a.shuffle.join(' ')"`
#bash lfrasson_tester.sh
#ARG="4 67 3 87 23"; ./../push_swap/push_swap $ARG | ./checker_linux $ARG

RELATIVE_PATH = r'../push_swap/push_swap'
