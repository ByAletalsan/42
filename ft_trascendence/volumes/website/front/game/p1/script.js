...
(function (window, document, THREE){
      ...
      switch(status)
      {
        ...
        case 1:
          ...
          case 2:
            ...
            window.postMessage((data_game['tour_id'] && (score.player1 > score.player2) && (data_game['mode'] != 'tour_final'))? 'endGameTour' : 'endGame', window.location.href + '/last_front/game/p1');
            status = 3;
          break;
      }
      if (renderer)
  ...
  async function init() {
    ...
    socket.onmessage = function(event) {
      ...
      else if (data.comando == 'ready_player2')
        enemyReady = true;
