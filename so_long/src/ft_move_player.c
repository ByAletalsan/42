...
static t_obj	*ft_can_move(t_list *list, int x, int y)
{
	...
	while (list)
	{
		...
		if (obj->c != 'P')
		{
			if (obj->x < x && obj->x + 64 > x && obj->y < y && obj->y + 64 > y)
				return (obj);
			if (obj->x < x + 64 && obj->x + 64 > x + 64 && obj->y < y && obj->y + 64 > y)
				return (obj);
			if (obj->x < x && obj->x + 64 > x && obj->y < y + 64 && obj->y + 64 > y + 64)
				return (obj);
			if (obj->x < x + 64 && obj->x + 64 > x + 64 && obj->y < y + 64 && obj->y + 64 > y + 64)
				return (obj);
			if (obj->x < x + 32 && obj->x + 64 > x + 32 && obj->y < y && obj->y + 64 > y)
				return (obj);
			if (obj->x < x + 64 && obj->x + 64 > x + 64 && obj->y < y + 32 && obj->y + 64 > y + 32)
				return (obj);
			if (obj->x < x + 32 && obj->x + 64 > x + 32 && obj->y < y + 64 && obj->y + 64 > y + 64)
				return (obj);
			if (obj->x < x && obj->x + 64 > x && obj->y < y + 32 && obj->y + 64 > y + 32)
				return (obj);
		}
		list = list->next;
	}
