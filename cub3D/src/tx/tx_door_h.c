...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/10/06 12:39:10 by atalaver          #+#    #+#             */
/*   Updated: 2023/10/06 14:50:09 by atalaver         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../../cub3D.h"

static void	door_h_tam_hight_height(t_var *v, t_vector *vc,
...
static void	door_h_tam_less_height(t_var *v, t_vector *vc,
	double x_print, t_tx tx)
{
...
void	print_texture_door_h(t_var *v, t_vector *vc, double x_print, double tam)
{
	t_tx	tx;
	...
	if (tx.tam <= HEIGHT)
	{
		...
		tx.z = tx.tam / (int)v->tx.t_door->height;
		tx.p = 0;
		door_h_tam_less_height(v, vc, x_print, tx);
	}
	else
	{
		tx.y = 0;
		...
		door_h_tam_hight_height(v, vc, x_print, tx);
	}
}
